...
def random_crop_and_resize(tensor, *, min_size):
    ...
    crop_height = tf.random_uniform([], minval=min_height, maxval=max_height, dtype=tf.int64)
    crop_width = tf.random_uniform([], minval=min_width, maxval=max_width, dtype=tf.int64)
